...
The following Plug-Ins are used as dictated by "plugins.txt":
Updates installed / generated by "generatePluginTxt.groovy".
Updated by Groovy Script "upgradeAllPlugins.groovy".

```
![Jenkins Plug-Ins](plugins.txt)
```

# Jenkins "Seed" Jobs

There are several seed jobs in the jenkins\jobs subdirectory.

```
1-github-seed-job.xml
2-job-dsl-seed-job.xml
3-conference-app-seed-job.xml
4-selenium2-seed-job.xml
5-docker-admin-seed-job.xml
```
